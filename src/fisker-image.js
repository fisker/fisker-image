;(function(root, factory) {
  ...
  var getImageTransformInfo = (function() {
    ...
    function getScaleSize(img, maxSize, rotate) {
      ...
      var maxWidth = rotate ? maxSize[1] : maxSize[0]
      var maxHeight = rotate ? maxSize[0] : maxSize[1]
    ...
    function getImageTransformInfo(img, orientation, maxSize) {
      ...
      return {
        ...
        deg: transform[2],
        rotated: rotated,
        scale: getScaleSize(img, maxSize, rotated)
      }
    }

    return getImageTransformInfo
  })()
  ...
  var getOrientation = (function() {
    ...
    function getOrientationFromFile(file) {
      return fileToArrayBuffer(file).then(getOrientationFromBuffer)
    }
